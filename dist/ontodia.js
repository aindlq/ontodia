...
exports.PLACEHOLDER_ELEMENT_TYPE = schema_1.PLACEHOLDER_ELEMENT_TYPE;
exports.PLACEHOLDER_LINK_TYPE = schema_1.PLACEHOLDER_LINK_TYPE;
...
var schema_2 = __webpack_require__(53);
exports.DIAGRAM_CONTEXT_URL_V1 = schema_2.DIAGRAM_CONTEXT_URL_V1;
...
var Element = /** @class */ (function () {
    ...
    Object.defineProperty(Element.prototype, "isFixedSize", {
        get: function () { return this._fixedSize; },
        enumerable: true,
        configurable: true
    });
    Element.prototype.setFixedSize = function (isFixed) {
        var previous = this._fixedSize;
        if (previous === isFixed) {
            return;
        }
        this._fixedSize = isFixed;
        this.source.trigger('changeFixedSize', { source: this, previous: previous });
    };
...
var OverlayedElement = /** @class */ (function (_super) {
    ...
    function OverlayedElement() {
        ...
        _this.requestResize = function () {
            _this.props.onResize(_this.props.state.element, react_dom_1.findDOMNode(_this));
        };
        return _this;
    }
    ...
    OverlayedElement.prototype.componentDidMount = function () {
        ...
        this.listener.listen(state.element.events, 'changeFixedSize', function (data) {
...
function computeTemplateProps(model, view) {
    ...
    return {
        ...
        size: model.size,
        setSize: function (s) { return model.setSize(s); },
        isFixedSize: model.isFixedSize,
        setFixedSize: function (b) { return model.setFixedSize(b); }
    };
}
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        queryTemplate = "\n          SELECT ?inst ?class {\n            VALUES(?inst) { ${ids} }\n            {\n              ${filterTypePattern}\n            } UNION {\n              # even if instance is untyped explicitly,\n              # we assume that everything is at least rdfs:Resource\n              BIND(rdfs:Resource as ?class)\n            }\n          }\n        ";
...
var model_1 = __webpack_require__(47);
var collections_1 = __webpack_require__(88);
var LABEL_URI = 'https://ontodia.org/context/v1.json/label';
var RDF_TYPE_URI = 'https://ontodia.org/context/v1.json/type';
    ...
    EditorController.prototype.showEditElementTypeForm = function (_a, fn) {
        ...
        var content = (React.createElement(editElementTypeForm_1.EditElementTypeForm, { editor: this, view: this.view, metadataApi: this.metadataApi, link: link.data, source: source.data, target: { value: target.data, isNew: targetIsNew }, onChangeElement: function (data) {
                ...
                if (existingTarget && existingTarget !== target) {
                    ...
                    _this.setTemporaryState(authoringState_1.TemporaryState.deleteElement(_this.temporaryState, previous));
                    target.setData(data);
                    _this.setTemporaryState(authoringState_1.TemporaryState.addElement(_this.temporaryState, data));
                }
...
var ElementTypeSelector = /** @class */ (function (_super) {
    ...
    function ElementTypeSelector(props) {
        ...
        _this.onElementTypeChange = function (classId) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var signal, _a, onChange, metadataApi, elementModel;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = this.props, onChange = _a.onChange, metadataApi = _a.metadataApi;
    ...
    ElementTypeSelector.prototype.renderExistingElementsList = function () {
        ...
        if (existingElements.length > 0) {
            return existingElements.map(function (element) {
                var _a;
                var elementFromDiagram = editor.model.elements.find(function (_a) {
                    var iri = _a.iri, group = _a.group;
                ...
                return (React.createElement(listElementView_1.ListElementView, { key: element.id, view: view, model: ((_a = elementFromDiagram) === null || _a === void 0 ? void 0 : _a.data) || element, disabled: !hasAppropriateType, selected: element.id === elementValue.value.id, onClick: function (e, model) { return _this.onSelectExistingItem(model); } }));
            });
        }
...
var EditLayer = /** @class */ (function (_super) {
    ...
    function EditLayer(props) {
        ...
        _this.createNewElement = function (source) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var _a, editor, metadataApi, elementTypes, classId, elementModel;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, async_1.CancellationToken.mapCancelledToNull(this.cancellation.signal, metadataApi.generateNewElement([classId], this.cancellation.signal))];
                    case 2:
                        elementModel = _b.sent();
                        if (elementModel === null) {
                            return [2 /*return*/];
                ...
                switch (_d.label) {
                    ...
                    case 9:
                        if (targetElement) {
                            ...
                            editor.showEditElementTypeForm({ link: modifiedLink, source: source, target: createdTarget, targetIsNew: true }, function (newLink) {
                                if (newLink) {
